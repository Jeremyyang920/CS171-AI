 ...
 */
public class PotentialPQDriver {
    ...
    public int lcsDynamic(char str1[],char str2[]){
        ...
        System.out.println(Arrays.deepToString(transposeMatrix(temp)));

        return max;
    
    }
    
    public int[][] transposeMatrix(int[][] temp2){
        int[][] temp = new int[temp2[0].length][temp2.length];
    ...
    public static void main(String args[]){
    	PotentialPQDriver lcs = new PotentialPQDriver();
        String str1 = "skullandbones";
        String str2 = "lullabybabies";
